...
<div>
	...
	<ul class="col-lg-1 col-sm-1 col-md-2 col-1" style="margin-top:40px;">
		...
		<button class="btn o" id="addcircle" title="Circle" style="margin-left:10px">
                    <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 250 250" width="24px"
                        height="24px" version="1.0" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <path fill="#F89833"
                ...
                <button class="btn o" id="addimage" title="Image" style="margin-left:10px">
                    <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 250 250" width="24px"
                        height="24px" version="1.0" xmlns:xlink="http://www.w3.org/1999/xlink">
		...
		<div class="row">
				<img class="col-lg-4 col-sm-3 col-3 col-md-4" style="height: 200px" src="Image1.png" />
			<div class="canvas col-lg-4 col-sm-3 col-6 col-md-4" style="">
			</div>
			<img class="col-lg-4 col-sm-3 col-3 col-md-4" style="height: 200px" src="image2.png" />
		</div>
        </div>
        <br>
