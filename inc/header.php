...
<head>
    ...
    <script src="assets/js/cans.js"></script> 
    <script src="https://cdnjs.cloudflare.com/ajax/libs/konva/7.2.5/konva.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/stampMakerStyle.css?v=<?php echo time(); ?>">
