...
function updateLabels(element, show) {
  ...
  $("#labels").prepend(" <div class='elementlabel mt-2' id='" + element + "'><div class=' all' id='" + element + "'><p style='border-bottom: 1px solid #0e4075; color: #0e4075; font-weight: 600;margin-bottom: 2px;'>" + showText + " <br /> " + showNumber + " </p></div><div style='display: flex; justify-content:space-between'> <button type='button' class='closeL btn' aria-label='Close' style='background: transparent; border: none; padding: 0px; color: #0e4075; font-weight: 600;'> Delete <img src='../assets/img/IconCross.svg' width='15px' height='15px' alt='cross' /></button><img width='30px' height='30px' src='../assets/img/IconArrows.svg' alt='icons' /></div></div>");
...
$(document).ready(function () {
  ...
  $("#addtriangle").click(function () {
    ...
    var moduleDiv = "<div id='Triangle" + (Triangles.length) + "' class='property'><div class='row'><div class='col-lg-12 col-sm-12 col-md-12 col-12 text-center'><div class='card properties-wrapper'><h5 class='property-heading'>Properties</h5> <h3>Triangle: " + (Triangles.length + 1) + "</h3><div class='slidecontainer color-element'><p>Fill Color:</p><input id='TriangleColorFill-" + (Triangles.length) + "' /></div><div class='slidecontainer color-element'><p>Stroke Color:</p><input id='TriangleColorStroke-" + (Triangles.length) + "' /></div><div class='slidecontainer'>Stroke width:<span class='range-slider__value'>0</span><input type='range' id='InputStrokeWidthTriangle-" + (Triangles.length) + "' class='slider' min='1' max='20' value='1'></div><div class='slidecontainer'>Size:<span class='range-slider__value'>0</span><input type='range' id='InputRadiusTriangle-" + (Triangles.length) + "' class='slider' min='1' max='80' value='20'></div><div class='custom-control custom-checkbox'><input type='checkbox' class='custom-control-input' id='InputTriangleCheckbox-" + (Triangles.length) + "'><label class='custom-control-label' for='InputTriangleCheckbox-" + (Triangles.length) + "'>Fill?</label></div></div></div></div></div>";


    $("#properties").append(moduleDiv);
    var Triangle = [$('#InputRadiusTriangle-' + (Triangles.length)).val(), $('#InputStrokeWidthTriangle-' + (Triangles.length)).val(), null, null, null, null, null, null, "Triangle", null, "#ff8800", "#ff8800", $('#InputTriangleCheckbox-' + (Triangles.length)).is(":checked")];
  ...
  $("#addsquare").click(function () {
    ...
    var moduleDiv = "<div id='Square" + (Squares.length) + "' class='property'><div class='row'><div class='col-lg-12 col-sm-12 col-md-12 col-12 text-center'><div class='card properties-wrapper'><h5 class='property-heading'>Properties</h5><h3>Square: " + (Squares.length + 1) + "</h3><div class='slidecontainer'><p>Fill Color:</p><input id='SquareColorFill-" + (Squares.length) + "' /></div><div class='slidecontainer'><p>Stroke Color:</p><input id='SquareColorStroke-" + (Squares.length) + "' /></div><div class='slidecontainer'>Stroke width:<span class='range-slider__value'>0</span><input type='range' id='InputStrokeWidthSquare-" + (Squares.length) + "' class='slider' min='1' max='20' value='1'></div><div class='slidecontainer'>Width:<span class='range-slider__value'>0</span><input type='range' id='InputRadiusSquare-" + (Squares.length) + "' class='slider' min='1' max='" + widthStage + "'' value=' 100'></div><div class='slidecontainer'>Height:<span class='range-slider__value'>0</span><input type='range' id='InputHeightSquare-" + (Squares.length) + "' class='slider' min='1' max='" + heightStage + "' value='100'></div><div class='custom-control custom-checkbox'><input type='checkbox' class='custom-control-input' id='InputSquareCheckbox-" + (Squares.length) + "'><label class='custom-control-label' for='InputSquareCheckbox-" + (Squares.length) + "'>Fill?</label></div><div class='custom-control custom-checkbox'><input type='checkbox' class='custom-control-input' id='InputSquareAspect-" + (Squares.length) + "'><label class='custom-control-label' for='InputSquareAspect-" + (Squares.length) + "'>Maintain Aspect Ratio?</label></div></div></div></div></div>";
    $("#properties").append(moduleDiv);

    var Square = [$('#InputRadiusSquare-' + (Squares.length)).val(), $('#InputStrokeWidthSquare-' + (Squares.length)).val(), null, null, null, null, null, null, "Square", null, "#ff8800", "#ff8800", $('#InputHeightSquare-' + (Squares.length)).val(), $('#InputSquareCheckbox-' + (Squares.length)).is(":checked"), $('#InputSquareAspect-' + (Squares.length)).is(":checked")];
  ...
  $("#addLine").click(function () {
    ...
    var moduleDiv = " <div id='Line" + (Lines.length) + "' class='property'><div class='row'><div class='col-lg-12 col-sm-12 col-md-12 col-12 text-center'><div class='card properties-wrapper'><h5 class='property-heading'>Properties</h5><h3>Line: " + (Lines.length + 1) + "</h3><div class='slidecontainer'><p>Fill Color:</p><input id='LineColorFillStroke-" + (Lines.length) + "' /></div><div class='slidecontainer'>Stroke width:<span class='range-slider__value'>0</span><input type='range' id='InputStrokeWidthLine-" + (Lines.length) + "' class='slider' min='1' max='30' value='15'></div><div class='slidecontainer'>Length:<span class='range-slider__value'>0</span><input type='range' id='InputLenghtLine-" + (Lines.length) + "' class='slider' min='1' max=" + stage.width() + " value=" + stage.width() / 2 + "></div><div class='slidecontainer'>Type:<select class='form-control' id='InputTypeLine-" + (Lines.length) + "'><option value='0'>Simple</option><option value='1'>Dashed</option><option value='2'>Arrow</option></select></div></div></div></div></div>";


    $("#properties").append(moduleDiv);
    var Line = [0, $('#InputStrokeWidthLine-' + (Lines.length)).val(), $('#InputLenghtLine-' + (Lines.length)).val(), "0", null, null, null, null, "Line", null, "#ff8800", "#ff8800"];
    //console.log(Line);
    Lines.push(Line);
  ...
  $("#addlinetext").click(function () {
    ...
    var moduleDiv = "<div id='LineText" + (LineTexts.length) + "' class='property'> <div class='row'> <div class='col-lg-12 col-md-12 col-sm-6 col-6'><div class='row'><div class='col-6 editor-btn'><div> <select id='InputFontLineText-" + (LineTexts.length) + "' class='form-control'> <option value='Arial' style='font-family: Arial' selected=''>Arial</option> <option value='Calibri' style='font-family: Calibri'>Calibri</option> <option value='Courier New' style='font-family: Courier New'>Courier New</option> <option value='Tahoma' style='font-family: Tahoma'>Tahoma</option> <option value='Times New Roma' style='font-family: Times New Roma'>Times New Roma</option> <option value='Verdana' style='font-family: Verdana'>Verdana</option> <option value='Comic Sans MS' style='font-family: Comic Sans MS'>Comic Sans MS</option> <option value='Days' style='font-family: Days'>Days</option> <option value='Simpleiriska' style='font-family: Simpleiriska'>Simpleiriska</option> <option value='Marck Script' style='font-family: Marck Script'>Marck Script</option> </select> </div></div> <div class='col-6 editor-btn'> <select id='InputFontSizeLineText-" + (LineTexts.length) + "' class='form-control'> <option>6</option> <option>7</option> <option>8</option> <option>9</option> <option>10</option> <option>12</option> <option>14</option> <option>16</option> <option selected=''>18</option> <option>20</option> <option>22</option> <option>24</option> <option>28</option> <option>30</option> <option>32</option> <option>34</option> <option>36</option> <option>38</option> <option>40</option> <option>42</option> <option>44</option> <option>46</option> <option>48</option> <option>50</option> <option>52</option> <option>54</option> <option>56</option> <option>60</option> <option>64</option> <option>72</option> <option>80</option> </select> </div></div> <div class='row mt-2'><div class='col-lg-6 col-md-7 col-sm-7 col-7 editor-btn'><div class='text-style-btns text-center'><button class='btn btn-sm modals'>B</button>|<button class='btn btn-sm modals'>I</button>|<button class='btn btn-sm modals'>U</button></div></div> <div class='col-lg-6 col-md-5 col-sm-5 col-5 editor-btn'> <div class='slidecontainer color-picker' id='co'>Color: <input style='width:100%;height:100%' id='LineColorText-" + (LineTexts.length) + "' /></div> </div><div class='col-12'>Text: <div class='slidecontainer'> <input type='text'id='InputTextLineText-" + (LineTexts.length) + "' class='text text-field' value='Text on the line'> </div></div> </div></div> <div class='col-lg-12 col-md-12 col-sm-6 col-6'><div class='row'><div class='col-lg-12 col-sm-12 col-md-12 col-12 text-center'><div class='card properties-wrapper'><h5 class='property-heading'>Properties</h5> <div class='slidecontainer'  style='display:none'> Horizontal Position: <span class='range-slider__value'>0</span> <input type='range' id='InputHorizontalPositionLineText-" + (LineTexts.length) + "' class='slider' min='0' max='250' value='125'> </div> <div class='slidecontainer' style='display:none'> Vertical Position:<span class='range-slider__value'>0</span> <input type='range' id='InputVerticalPositionLineText-" + (LineTexts.length) + "' class='slider' min='0' max='280' value='120'> </div> <div class='slidecontainer' style='display:none;'> Rotation:<span class='range-slider__value'>0</span> <input type='range' id='InputRotationLineText-" + (LineTexts.length) + "' class='slider' min='0' max='360' value='0'> </div> <div class='slidecontainer'>Width:<span class='range-slider__value'>0</span><input type='range' id='InputWidthTextLine-" + (LineTexts.length) + "'  class='slider' min='1' max='" + widthStage + "'' value='100'></div><div class='slidecontainer'>Height:<span class='range-slider__value'>0</span><input type='range' id='InputHeightTextLine-" + (LineTexts.length) + "'  class='slider' min='1' max='" + heightStage + "'' value='100'></div><div class='custom-control custom-checkbox'><input type='checkbox' class='custom-control-input' id='InputLineTextAspect-" + (LineTexts.length) + "'><label class='custom-control-label' for='InputLineTextAspect-" + (LineTexts.length) + "'>Maintain Aspect Ratio?</label></div> </div></div></div></div></div></div>";
    $("#properties").append(moduleDiv);
  ...
  function stageBackground() {
    document.getElementsByClassName("mobile-view")[0].style.bottom = "3.8em"
    hideallproperties();
    var moduleDiv = "<div style='display:none;' id='stageBackground0' class='property'><div class='row'><div class='col-lg-12 col-sm-12 col-md-12 col-12 text-center'><div class='card properties-wrapper'><h5 class='proprty-heading'>Properties</h5> <h3>Background</h3><div class=' slidecontainer'>Background Type:<select class='form-control' id='stagebackgroundtype-0'><option value='1'>Fill</option><option value='2'>Gradient</option><option value='3' selected>Image</option></select></div><div id='appends'></div></div></div></div></div>";
    $("#properties").append(moduleDiv);
