   ...
   function updateLabels(element, show,id) {
       ...
       $("#layers").append("<div class='layer elementlabel all' id='" + element + "'>"+show+"<p>#"+id+"</p><hr><div style='display: flex;flex-direction: row;' id='layerContent'>Delete &nbsp;<span style='color:red' id='" + element + "'  class='closeL'>&times; </span> &nbsp;&nbsp;<img src='img/up.PNG' class='up' style='width:10px;height: 10px;margin-top:5px;'><img src='img/up.PNG' class='down' style='transform: rotate(180Deg);width:10px;height: 10px;margin-top:5px;'></div></div>");
   ...
   $(document).ready(function() {
       ...
       $(".addcircle").click(function() {
           ...
           var moduleDiv = "<div id='Circle" + (Circles.length) + "' class='prop'><div id='propButtons'><input id='CircleColor-" + (Circles.length) + "'  /></div><div id='properties' class='shadow'><center style='color:var(--primary)'>Properties</center><br><hr class='hr'><div class='slidecontainer'>Radius:<span class='range-slider__value'>0</span><input type='range' id='InputRadiusCircle-" + (Circles.length) + "'  class='slider' min='30' max='240' value='260'></div><div class='slidecontainer'>Stroke width:<span class='range-slider__value'>0</span><input type='range' id='InputStrokeWidthCircle-" + (Circles.length) + "'  class='slider' min='1' max='100' value='1'></div></div></div>";
       ...
       $(".addimage").click(function() {
           ...
           var moduleDiv = " <div class='prop' id='Picture" + (Pictures.length) + "' >                                    <div id='properties' class='shadow'>                        <center style='color:var(--primary)'>Properties</center>                        <br>                        <hr class='hr'>                        <br>                        <center>Image:</center>                        <input type='file' id='InputPictureSrc-" + (Pictures.length) + "' name='files' style=font-size:15px'/>                        Horizontal Position:                          <span class='range-slider__value'>0</span> <input type='range' id='InputPictureHorizontalPosition-" + (Pictures.length) + "'  class='slider' min='1' max='250' value='126' >                          Vertical Position:                          <span class='range-slider__value'>0</span>    <input type='range' id='InputPictureVerticalPosition-" + (Pictures.length) + "'  class='slider' min='1' max='250' value='126' >                           Size:                          <span class='range-slider__value'>0</span>     <input type='range' id='InputPictureSize-" + (Pictures.length) + "'  class='slider' min='1' max='250' value='250' >                         Rotation:                         <span class='range-slider__value'>0</span>  <input type='range' id='InputPictureRotation-" + (Pictures.length) + "'  class='slider' min='0' max='360' value='0' >                                      </div>   ";
       ...
       function updateTheCanvas() {
           rangeSlider();
           var fore = $('.pickup').val();
           $('.canvas').prepend(getCircularText(fore, Circles, RoundTexts, LineTexts, Pictures, DeletedElements));
       ...
       $(document).on('change input click', 'input[type=text],input[type=range],input[type=file], select, button:not(.close,.swal-button,.modals),img:not(.addlinetext,.addroundtext,.addcircle,.addimage)', function() {
