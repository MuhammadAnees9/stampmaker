...
function updateLabels(element, show) {
  console.log("hwlllllooooo")
  let showVal = show.split(" ");
  let showText = showVal[0]
  let showNumber = showVal[1]
  $(".card-item").removeClass("all");
  $("#labels").prepend("<div class='elementlabel mt-2' id='" + element + "'><div class=' card-item all' id='" + element + "'><p style='border-bottom: 1px solid blue; color: blue; font-weight: 600;margin-bottom: 2px;'>" + showText + " <br /> " + showNumber + " </p></div><div style='isplay: flex; justify-content:space-between'> <button type='button' class='closeL btn' aria-label='Close'style='background: transparent; border: none; padding: 0px; color: blue; font-weight: 600;'>Delete<img width='15px' height='15px' src='aasets/img/IconCross.svg' /></button><img width='30px' height='30px' src='assets/img/IconArrows.svg' alt='icons' /></div></div>");
...
$(document).ready(function () {
  ...
  $("#addroundtext").click(function () {
    ...
    var moduleDiv = " <div id='RoundText" + (RoundTexts.length) + "' class='property'><div class='row'><div class='col-lg-12 col-md-12 col-sm-6 col-6'><div class='row'><div class='col-6 editor-btn'><div> <select id='InputFontRoundText-" + (RoundTexts.length) + "'class='form-control col-sm'><option value='Arial' style='font-family: Arial'selected='>Arial</option><option value=' Calibri'style='font-family: Calibri'>Calibri</option><option value='Courier New' style='font-family: Courier New'>Courier New</option><option value='Tahoma' style='font-family: Tahoma'>Tahoma</option><option value='Times New Roma' style='font-family: Times New Roma'>Times NewRoma</option><option value='Verdana' style='font-family: Verdana'>Verdana</option><option value='Comic Sans MS' style='font-family: Comic Sans MS'>Comic Sans MS</option><option value='Days' style='font-family: Days'>Days</option><option value='Simpleiriska' style='font-family: Simpleiriska'>Simpleiriska</option><option value='Marck Script' style='font-family: Marck Script'>Marck Script</option></select></div></div><div class='col-6 editor-btn'><select id='InputFontSizeRoundText-" + (RoundTexts.length) + "'class='form-control col-sm'><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>12</option><option>14</option><option>16</option><option selected=''>18</option><option>20</option><option>22</option><option>24</option><option>28</option><option>30</option><option>32</option><option>34</option><option>36</option><option>38</option><option>40</option><option>42</option><option>44</option><option>46</option><option>48</option><option>50</option><option>52</option><option>54</option><option>56</option><option>60</option><option>64</option><option>72</option><option>80</option></select></div></div><div class='row mt-2'><div class='col-lg-6 col-md-7 col-sm-7 col-7 editor-btn'><div class='text-style-btns text-center'><button class='btn btn-sm modals'>B</button>|<button class='btn btn-sm modals'>I</button>|<button class='btn btn-sm modals'>U</button></div></div><div class='col-lg-6 col-md-5 col-sm-5 col-5 editor-btn'><div class='slidecontainer round-color'>Color:<input id='RoundColor-" + (RoundTexts.length) + "' /></div></div><div class='col-12'>Text: <div class='slidecontainer'> <input type='text'id='InputTextRoundText-" + (RoundTexts.length) + "' class='text text-field' value='Text around the circle'></div></div></div></div><div class='col-lg-12 col-md-12 col-sm-6 col-6'><div class='row'><div class='col-lg-12 col-sm-12 col-md-12 col-12 text-center'><div class='card properties-wrapper'><h5 class='heading' style='color: blue; border-bottom: 2px solid blue; padding-bottom: 20px;margin-bottom: 2em;'>Properties</h5><div class='slidecontainer'> Radius: <span class='range-slider__value'>0</span><input type='range' id='InputRadiusRoundText-" + (RoundTexts.length) + "' class='slider' min='30' max='406' value='150'> </div><div class='slidecontainer'> Spacing:<span class='range-slider__value'>0</span><input type='range' id='InputSpacingRoundText-" + (RoundTexts.length) + "'class='slider' min='1.00' max='10.00' value='1'> </div><div class='slidecontainer'> Start Point:<span class='range-slider__value'>0</span><input type='range' id='InputStartingPointRoundText-" + (RoundTexts.length) + "'class='slider' min='0' max='360' value='0'> </div><div class='slidecontainer' style='display:none'>Width:<span class='range-slider__value' style='display:none'>0</span><input type='range' id='InputWidthRoundText-" + (RoundTexts.length) + "' style='display:none' class='slider' min='1' max='200' value='100'></div><div class='slidecontainer' style='display:none'>Height:<span class='range-slider__value'>0</span><input type='range' style='display:none' id='InputHeightRoundText-" + (RoundTexts.length) + "' class='slider' min='1' max='200' value='100'></div><div class='custom-control custom-checkbox'><input type='checkbox' style='display:none' class='custom-control-input' id='InputRoundTextAspect-" + (RoundTexts.length) + "'><label style='display:none' class='custom-control-label'for='InputRoundTextAspect-" + (RoundTexts.length) + "'>Maintain AspectRatio?</label></div></div></div></div></div></div></div>";
    $("#properties").append(moduleDiv);
