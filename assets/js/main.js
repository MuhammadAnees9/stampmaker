...
function updateLabels(element, show) {
  ...
  $("#labels").prepend("<div class='elementlabel mt-2' id='" + element + "'><div class=' card-item card-item-n all' id='" + element + "'><p style='border-bottom: 1px solid #518bc7; color: #0a67ca; font-weight: 600;margin-bottom: 2px;'>" + showText + " <br /> " + showNumber + " </p></div><button type='button' id='LineText' class='closeL btn' aria-label='Close'style='background: transparent; border: none; padding: 0px; color: #0a6bcb; font-weight: 600;'>Delete<img width='15px' height='15px' src='assets/img/IconCross.svg' /></button><div class='arrows-up-down'><span class='move-up-element'><img class='arrowup' src='assets/img/uparrow.png' width='12' height='12'></span><span class='move-down-element'><img class='arrowdown' src='assets/img/downarrow.png' width='12' height='12'></span></div></div>");    //two buttons usman
