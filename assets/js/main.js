...
function updateLabels(element, show) {
  ...
  $("#labels").prepend("<div class='elementlabel mt-2' id='" + element + "'><div class=' card-item card-item-n all' id='" + element + "'><p style='border-bottom: 1px solid #518bc7; color: #0a67ca; font-weight: 600;margin-bottom: 2px;'>" + showText + " <br /> " + showNumber + " </p></div><div style='display: flex; justify-content:space-between'> <button type='button' id='LineText' class='closeL btn' aria-label='Close'style='background: transparent; border: none; padding: 0px; color: #0a6bcb; font-weight: 600;'>Delete<img width='15px' height='15px' src='assets/img/IconCross.svg' /></button><span class='move-up-element'><i style='color: #0e4075;' class='fa fa-chevron-up'></i></span><span class='move-down-element'><i style='color: #0e4075;' class='fa fa-chevron-down'></i></span></div></div>");
