...
$(document).ready(function () {
  ...
  $("#addcircle").click(function () {
    ...
    var moduleDiv = " <div id='Circle" + (Circles.length) + "' class='property'><div class='row'><div class='col-lg-12 col-sm-12 col-md-12 col-12 text-center'><div class='card properties-wrapper'><h5 class='heading' style='color: blue; border-bottom: 2px solid blue; padding-bottom: 20px;margin-bottom: 2em;'>Properties</h5> <h3>Circle: " + (Circles.length + 1) + "</h3><div class='slidecontainer color-element'><p>Color:</p><input id='CircleColor-" + (Circles.length) + "' /></div><div class='slidecontainer'>Radius:<span class='range-slider__value'>0</span><input type='range' id='InputRadiusCircle-" + (Circles.length) + "' class='slider' min='30' max='240' value='260'></div><div class='slidecontainer'>Stroke width:<span class='range-slider__value'>0</span><input type='range' id='InputStrokeWidthCircle-" + (Circles.length) + "' class='slider' min='1' max='100' value='1'></div></div></div><div class='col-12 mt-2'><div class='demo bottomleft' id='howto' onclick='toggleinstruction()'>Suggestions and concerns <b>Click Here</b></div></div></div></div>";
